...
const content: React.CSSProperties = { margin: '8px 10px', borderRadius: 12, boxShadow:'inset 0 0 0 3px #8cbcff', background:'rgba(0,0,0,0.05)', position:'relative', paddingBottom: 104 }
...
const bottomNav: React.CSSProperties = {
    ...
    borderRadius:12,
    boxShadow:'inset 0 0 0 3px #0b2f68, 0 8px 16px rgba(0,0,0,0.25)'
}
