    ...
    return (
        <div style={{ position: 'relative', width: size, height: size, touchAction:'none' }} onClick={handleSelectAt}>
            ...
            {(() => {
                ...
                return (
                    <img src="/plus.png" alt="plus" style={{ position:'absolute', left: 12, bottom: 12, width: PLUS_SIZE, height: PLUS_SIZE, transform:`rotate(${rotateDeg + 40}deg)`, transformOrigin:'50% 50%', pointerEvents:'none', filter:'drop-shadow(0 6px 10px rgba(0,0,0,0.25))' }} />
                )
            })()}
